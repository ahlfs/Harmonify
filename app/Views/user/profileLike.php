...
<div class="box">
  <div class="photobar">
    <a href="/profile/<?= $user['UserID']; ?>" class="no-decoration no-underline photoButtonCreated" draggable="false"><i class="fa-solid fa-table-cells-large" style="color: #63E6BE;"></i> Created</a>
    <a href="/profile/<?= $user['UserID']; ?>/liked" class="underline no-decoration photoButtonSaved selected" draggable="false"><i class="fa-solid fa-heart" style="color: #ff0000;"></i> Like</a>
